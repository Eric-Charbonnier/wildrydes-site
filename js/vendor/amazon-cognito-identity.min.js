...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.AmazonCognitoIdentity = t(
        require("aws-sdk/global"),
        require("aws-sdk/clients/cognitoidentityserviceprovider")
      ))
    : (e.AmazonCognitoIdentity = t(
        e.AWSCognito,
        e.AWSCognito.CognitoIdentityServiceProvider
      ));
})(this, function (e, t) {
  return (function (e) {
    function t(i) {
    ...
    function (e, t, n) {
      ...
      var r = (function () {
        ...
        h = (function () {
          function e(t) {
            s(this, e),
              (this.N = new u.default(l, 16)),
              (this.g = new u.default("2", 16)),
              (this.k = new u.default(
                this.hexHash(
              ...
              (this.infoBits = new o.util.Buffer(
                "Caldera Derived Key",
                "utf8"
              )),
              (this.poolName = t);
            ...
            r(e, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  var r = this.g.modPow(
                    new u.default(this.hexHash(this.SaltToHashDevices + i), 16),
                    this.N
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (t.mod(this.N).equals(u.default.ZERO))
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = o.util.crypto.hmac(t, e, "buffer", "sha256"),
                    i = o.util.buffer.concat([
                      this.infoBits,
                      new o.util.Buffer(String.fromCharCode(1), "utf8"),
                    ]),
              ...
              },
              {
                ...
                value: function (e, t, n, i) {
                  if (n.mod(this.N).equals(u.default.ZERO))
                    throw new Error("B cannot be zero.");
                  if (
                    ((this.UValue = this.calculateU(this.largeAValue, n)),
                    this.UValue.equals(u.default.ZERO))
                  )
                  ...
                  var s = "" + this.poolName + e + ":" + t,
                    ...
                    h = c
                      .modPow(
                        this.smallAValue.add(this.UValue.multiply(a)),
                        this.N
                      )
                      .mod(this.N),
                    f = this.computehkdf(
                      new o.util.Buffer(this.padHex(h), "hex"),
                      new o.util.Buffer(
                        this.padHex(this.UValue.toString(16)),
                        "hex"
                      )
                    );
                  return f;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    t.length % 2 === 1
                      ? (t = "0" + t)
                      : "89ABCDEFabcdef".indexOf(t[0]) !== -1 && (t = "00" + t),
                    t
                  );
                },
              },
    ...
    function (e, t) {
      ...
      function f(e) {
        ...
        if (a-- > 0)
          for (
            u < this.DB && (n = this[a] >> u) > 0 && ((s = !0), (o = r(n)));
            a >= 0;

          )
            u < t
              ? ((n = (this[a] & ((1 << u) - 1)) << (t - u)),
                (n |= this[--a] >> (u += this.DB - t)))
              : ((n = (this[a] >> (u -= t)) & i),
                u <= 0 && ((u += this.DB), --a)),
              n > 0 && (s = !0),
              s && (o += r(n));
      ...
      function U(e, t, s) {
        ...
        if (!(r.t <= 0)) {
          ...
          if (o.t < r.t)
            return (
              null != t && t.fromInt(0), void (null != s && this.copyTo(s))
            );
          null == s && (s = i());
          var a = i(),
            u = this.s,
            ...
            c = this.DB - m(r[r.t - 1]);
          c > 0
            ? (r.lShiftTo(c, a), o.lShiftTo(c, s))
            : (r.copyTo(a), o.copyTo(s));
          var h = a.t,
            f = a[h - 1];
          if (0 != f) {
            ...
            for (
              a.dlShiftTo(S, C),
                s.compareTo(C) >= 0 && ((s[s.t++] = 1), s.subTo(C, s)),
                n.ONE.dlShiftTo(h, C),
                C.subTo(a, a);
              a.t < h;
            ...
            for (; --S >= 0; ) {
              var w =
                s[--y] == f
                  ? this.DM
                  : Math.floor(s[y] * v + (s[y - 1] + p) * g);
              if ((s[y] += a.am(0, w, s, S, 0, h)) < w)
                for (a.dlShiftTo(S, C), s.subTo(C, s); s[y] < --w; )
                  s.subTo(C, s);
            }
            null != t && (s.drShiftTo(h, t), u != l && n.ZERO.subTo(t, t)),
              (s.t = h),
              s.clamp(),
              c > 0 && s.rShiftTo(c, s),
        ...
        for (s = m(e[g]) - 1; g >= 0; ) {
          for (
            s >= c
              ? (d = (e[g] >> (s - c)) & h)
              : ((d = (e[g] & ((1 << (s + 1)) - 1)) << (c - s)),
                g > 0 && (d |= e[g - 1] >> (this.DB + s - c))),
              u = n;
            0 == (1 & d);

          )
            (d >>= 1), --u;
          if (((s -= u) < 0 && ((s += this.DB), --g), p))
            a[d].copyTo(r), (p = !1);
          else {
            for (; u > 1; ) o.sqrTo(r, y), o.sqrTo(y, r), (u -= 2);
            u > 0 ? o.sqrTo(r, y) : ((v = r), (r = y), (y = v)),
              o.mulTo(y, a[d], r);
          }
          for (; g >= 0 && 0 == (e[g] & (1 << s)); )
            o.sqrTo(r, y),
      ...
      (n.prototype.DB = j),
        ...
        (n.prototype.DV = 1 << j);
      var x = 52;
      (n.prototype.FV = Math.pow(2, x)),
        (n.prototype.F1 = x - j),
        (n.prototype.F2 = 2 * j - x);
      var H,
        L,
      ...
      (B.prototype.convert = O),
        ...
        (n.prototype.drShiftTo = S),
        (n.prototype.lShiftTo = C),
        (n.prototype.rShiftTo = w),
        (n.prototype.subTo = k),
        (n.prototype.multiplyTo = A),
        (n.prototype.squareTo = T),
        (n.prototype.divRemTo = U),
        (n.prototype.invDigit = D),
        (n.prototype.addTo = b),
        (n.prototype.toString = f),
        (n.prototype.negate = d),
        (n.prototype.abs = v),
        (n.prototype.compareTo = g),
        (n.prototype.bitLength = p),
        (n.prototype.mod = E),
        (n.prototype.equals = I),
        (n.prototype.add = P),
        (n.prototype.subtract = R),
        (n.prototype.multiply = F),
        (n.prototype.divide = _),
        (n.prototype.modPow = q),
        (n.ZERO = l(0)),
        (n.ONE = l(1));
    },
    function (e, t, n) {
        ...
        U = (function () {
          function e(t) {
            ...
            (this.username = t.Username || ""),
              ...
              (this.storage = new T.default().getStorage());
          }
          return (
            r(e, [
              {
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  null != this.deviceKey && (l.DEVICE_KEY = this.deviceKey),
                    ...
                    (l.SRP_A = i.getLargeAValue().toString(16)),
                    "CUSTOM_AUTH" === this.authenticationFlowType &&
                      (l.CHALLENGE_NAME = "SRP_A"),
                    this.client.makeUnauthenticatedRequest(
                      ...
                      function (l, c) {
                        ...
                        (n.username = h.USER_ID_FOR_SRP),
                          (r = new u.default(h.SRP_B, 16)),
                          (a = new u.default(h.SALT, 16)),
                          n.getCachedDeviceKeyAndPassword();
                        var f = i.getPasswordAuthenticationKey(
                            n.username,
                            e.getPassword(),
                            r,
                            a
                          ...
                          d = s.getNowString(),
                          v = o.util.crypto.hmac(
                            f,
                            o.util.buffer.concat([
                              new o.util.Buffer(
                                n.pool.getUserPoolId().split("_")[1],
                                "utf8"
                              ),
                              new o.util.Buffer(n.username, "utf8"),
                              new o.util.Buffer(h.SECRET_BLOCK, "base64"),
                              new o.util.Buffer(d, "utf8"),
                            ]),
                            "base64",
                            "sha256"
                          ),
                          g = {};
                        (g.USERNAME = n.username),
                          (g.PASSWORD_CLAIM_SECRET_BLOCK = h.SECRET_BLOCK),
                          (g.TIMESTAMP = d),
                          (g.PASSWORD_CLAIM_SIGNATURE = v),
                          null != n.deviceKey && (g.DEVICE_KEY = n.deviceKey);
                        var m = function e(t, i) {
                          return n.client.makeUnauthenticatedRequest(
                            ...
                            function (s, r) {
                              return s &&
                                "ResourceNotFoundException" === s.code &&
                                s.message.toLowerCase().indexOf("device") !== -1
                                ? ((g.DEVICE_KEY = null),
                                  (n.deviceKey = null),
                            ...
                            if ("NEW_PASSWORD_REQUIRED" === r) {
                              ...
                              if (
                                (s.ChallengeParameters &&
                                  ((o = JSON.parse(
                                    s.ChallengeParameters.userAttributes
                                  )),
                                  (a = JSON.parse(
                                    s.ChallengeParameters.requiredAttributes
                                  ))),
                                a)
                              )
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if ("SMS_MFA" === s)
                    return (this.Session = e.Session), n.mfaRequired(s, r);
                  if ("CUSTOM_CHALLENGE" === s)
                    return (this.Session = e.Session), n.customChallenge(r);
                  ...
                  var u = {
                    ...
                    PasswordVerifier: new o.util.Buffer(
                      t.getVerifierDevices(),
                      "hex"
                    ).toString("base64"),
                  };
                  (this.verifierDevices = u.PasswordVerifier),
                    (this.deviceGroupKey = a.DeviceGroupKey),
                    (this.randomPassword = t.getRandomPassword()),
                    this.client.makeUnauthenticatedRequest(
                      "confirmDevice",
                      {
                      ...
                      function (t, s) {
                        return t
                          ...
                          : ((i.deviceKey =
                            ...
                            s.UserConfirmationNecessary === !0
                              ? n.onSuccess(
                                  i.signInUserSession,
                                  s.UserConfirmationNecessary
                                )
                  ...
                  t &&
                    ...
                    this.client.makeUnauthenticatedRequest(
                      ...
                      function (e, t) {
                        return e
                          ? n.onFailure(e)
                          : i.authenticateUserInternal(t, s, n);
                      }
                    );
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  (s.USERNAME = this.username),
                    ...
                    (s.SRP_A = n.getLargeAValue().toString(16)),
                    this.client.makeUnauthenticatedRequest(
                      "respondToAuthChallenge",
                      {
                      ...
                      function (s, r) {
                        ...
                        var a = r.ChallengeParameters,
                          ...
                          h = n.getPasswordAuthenticationKey(
                            t.deviceKey,
                            t.randomPassword,
                            l,
                            c
                          ...
                          f = i.getNowString(),
                          d = o.util.crypto.hmac(
                            h,
                            o.util.buffer.concat([
                              new o.util.Buffer(t.deviceGroupKey, "utf8"),
                              new o.util.Buffer(t.deviceKey, "utf8"),
                              new o.util.Buffer(a.SECRET_BLOCK, "base64"),
                              new o.util.Buffer(f, "utf8"),
                            ]),
                            "base64",
                            "sha256"
                          ),
                        ...
                        (v.USERNAME = t.username),
                          (v.PASSWORD_CLAIM_SECRET_BLOCK = a.SECRET_BLOCK),
                          (v.TIMESTAMP = f),
                          (v.PASSWORD_CLAIM_SIGNATURE = d),
                          (v.DEVICE_KEY = t.deviceKey),
                  ...
                  (i.USERNAME = this.username),
                    ...
                    this.client.makeUnauthenticatedRequest(
                      ...
                      function (e, i) {
                        ...
                        return "CUSTOM_CHALLENGE" === s
                          ? ((n.Session = i.Session),
                            t.customChallenge(i.ChallengeParameters))
                  ...
                  (i.USERNAME = this.username),
                    ...
                    this.client.makeUnauthenticatedRequest(
                      ...
                      function (e, i) {
                        ...
                        var s = i.ChallengeName;
                        if ("DEVICE_SRP_AUTH" === s)
                          return void n.getDeviceResponse(t);
                        if (
                          ((n.signInUserSession = n.getCognitoUserSession(
                            i.AuthenticationResult
                          )),
                          n.cacheTokens(),
                          null == i.AuthenticationResult.NewDeviceMetadata)
                        )
                          return t.onSuccess(n.signInUserSession);
                        var r = new c.default(
                          n.pool.getUserPoolId().split("_")[1]
                        );
                        r.generateHashDevice(
                          i.AuthenticationResult.NewDeviceMetadata
                            .DeviceGroupKey,
                          i.AuthenticationResult.NewDeviceMetadata.DeviceKey
                        );
                        var a = {
                          Salt: new o.util.Buffer(
                            r.getSaltDevices(),
                            "hex"
                          ).toString("base64"),
                          PasswordVerifier: new o.util.Buffer(
                        ...
                        (n.verifierDevices = a.PasswordVerifier),
                          (n.deviceGroupKey =
                            i.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey),
                          (n.randomPassword = r.getRandomPassword()),
                          n.client.makeUnauthenticatedRequest(
                            "confirmDevice",
                            {
                              DeviceKey:
                                i.AuthenticationResult.NewDeviceMetadata
              ...
              },
              {
                key: "changePassword",
                value: function (e, t, n) {
                  return null != this.signInUserSession &&
                  ...
                  return null != this.signInUserSession &&
                    ...
                    ? void this.client.makeUnauthenticatedRequest(
                        ...
                        function (n) {
                          return n
                            ? e(n, null)
                            : (t.clearCachedTokens(), e(null, "SUCCESS"));
                        }
                      )
                      ...
                      if (s) {
                        ...
                        return (
                          Object.prototype.hasOwnProperty.call(
                            r,
                            "RefreshToken"
                          ) || (r.RefreshToken = e.getToken()),
                          (n.signInUserSession = n.getCognitoUserSession(r)),
                          n.cacheTokens(),
              ...
              },
              {
                ...
                value: function (e) {
                  var t = new v.default(e),
                    n = new f.default(e),
                    i = new m.default(e),
                    s = { IdToken: t, AccessToken: n, RefreshToken: i };
                  ...
                  return null != this.signInUserSession &&
                    ...
                    ? void this.client.makeUnauthenticatedRequest(
                        ...
                        function (n) {
                          return n
                            ? e.onFailure(n)
                            : (t.clearCachedTokens(), e.onSuccess("SUCCESS"));
                        }
                      )
                    : e.onFailure(new Error("User is not authenticated"));
                },
